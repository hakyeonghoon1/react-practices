        ...
        <form id="joinForm" name="joinForm" method="post" action="/do/not/post">
            ...
            <input 
                ...
                onChange={onChangeInputEmail} />
                {
                    email === '' ?
                    null :
                    validEmail ? <FontAwesomeIcon icon={faCheckCircle} style={{marginLeft:5,fontSize:16,color:'blue'}}/> :
            ...
            <fieldset>
                <legend>성별</legend>
                <label>여</label> <input type="radio" name="gender" onChange={onChangeInputGender} value={ "female" } checked={gender ==='female'} defaultChecked={ true } />
                <label>남</label> <input type="radio" name="gender" onChange={onChangeInputGender} value={ "male" } checked={gender ==='male'}  defaultChecked={ false } />
            </fieldset>
