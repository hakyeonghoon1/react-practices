...
2. ECMAScript 년도별로 모아놓은 것들, stage(0, 1, 2, 3) 레벨로 모아 놓은 것, 3rd party(typescript, react)
3. Env Preset stage 3레벨 이상되는 문법들의 플러그인
...
$ npm list --depth --depth=1 | grep "babel-plugin"
